...
/*   Updated: 2023/07/26 19:01:24 by lsordo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* === TEST 1 === */
		...
		std::cout << container.shortestSpan() << std::endl; // 9
		std::cout << container.longestSpan() << std::endl; // 4999
/* === TEST 2 ==== */
...
/* === TEST 5 ==== */
		...
		container.improvedAddNumber(sourceVector);
		std::cout << container.shortestSpan() << std::endl;
		std::cout << container.longestSpan() << std::endl;
...
/* === TEST 6 ==== */
		...
		std::cout << container.longestSpan() << std::endl;
		std::cout << container << std::endl;
		std::cout << BYELLOW << "Copy constructor"<< RESET << std::endl;
		...
		std::cout << BYELLOW << "Assignment operator"<< RESET << std::endl;
