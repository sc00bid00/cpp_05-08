...
/*   Updated: 2023/07/04 14:57:24 by lsordo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form& form) const {
	if (form.getSigned() && this->getBureaucratGrade() <= form.getGradeToSign())
		...
		std::cout << BRED << this->getBureaucratName() << " couldn't sign " << form.getFormName() << " because it requires grade " << form.getGradeToSign() << ", " << this->getBureaucratName() << " has grade " << this->getBureaucratGrade() << RESET << std::endl;
}
